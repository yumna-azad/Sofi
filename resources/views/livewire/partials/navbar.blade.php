    ...
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <a href="/" aria-label="Brand">
          <img src="images/logo.png" alt="DCodeMania Logo" class="h-14 w-auto">
        </a>
        <div class="md:hidden">
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid">
            ...
            <a class="font-medium text-gray-500 hover:text-gray-400 py-3 md:py-6" href="/categories">
              Categories
            </a>

            <a class="font-medium text-gray-500 hover:text-gray-400 py-3 md:py-6" href="/products">
              Products
            </a>
            ...
            <div class="pt-3 md:pt-0">
              <a class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-yellow-600 text-white hover:bg-yellow-700 disabled:opacity-50 disabled:pointer-events-none" href="/login">
            ...
            <div class="md:py-4">
              ...
              <!-- Dropdown Menu -->
              <div class="transition-all duration-300 w-48 bg-white shadow-md rounded-lg p-2 max-h-[200px] overflow-y-auto">
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500"wire:navigate  href="/my-orders">
                  My Orders
                </a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a href="{{ route('logout') }}" class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500"
