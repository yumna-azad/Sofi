    ...
    <div class="flex flex-col md:flex-row gap-4">
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          @if ($cart_items)
            <button class="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full"><a href="/checkout" class="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
            </button>
          @endif
        </div>
      </div>
